...
public class BibLineFactoryTest {
	...
	public final void testFE() throws IllFormattedLineException {
		...
		line = LineParser.parse("3100 Kernforschungszentrum <Karlsruhe>" + " / Projekt Nukleare Sicherheit", TAG_DB,
				false);
		assertEquals("3100  |$a|:Kernforschungszentrum |$c|:Karlsruhe" + " |$b|:Projekt Nukleare Sicherheit",
				line.toString());
		...
		assertEquals("027A ƒSbƒaZehn kleine Negerlein", RecordUtils.toPica(line, Format.PICA_PLUS, true, 'ƒ'));
		...
		assertEquals("028A $dJohann Wolfgang$aGoethe", RecordUtils.toPica(line, Format.PICA_PLUS, true, '$'));
		...
		assertEquals("028C $dAnita$aDietze$BHrsg.", RecordUtils.toPica(line, Format.PICA_PLUS, true, '$'));
		...
		// "4000 Vertrag : Internationaler Halbzeug-Verband ; 18. 7. 33 |a| =
		// Convention", TAG_DB,
		// false);
		// assertEquals(
		// "4000 |$a|:Vertrag |$d|:Internationaler Halbzeug-Verband ; 18. 7. 33 |$S|:a
		// |$f|:Convention",
		// line.toString());
		// line = LineParser.parse(
		// "021A ƒaVertragƒdInternationaler Halbzeug-Verband ; 18. 7.
		// 33ƒSaƒfConvention", TAG_DB, false);
		// assertEquals(
		// "4000 |$a|:Vertrag |$d|:Internationaler Halbzeug-Verband ; 18. 7. 33 |$S|:a
		// |$f|:Convention",
		// line.toString());
		// assertEquals("4000 Vertrag : Internationaler Halbzeug-Verband ; 18. 7. 33 |a|
		// = Convention",
		// RecordUtils.toPica(line, Format.PICA3, true, '$'));

		line = LineParser.parse("4030 Bonn ; München ; Paris {[u.a.] : Addison-Wesley", TAG_DB, false);
		assertEquals("4030  |$p|:Bonn |$p|:München |$p|:Paris {[u.a.] |$n|:Addison-Wesley", line.toString());
		...
		assertEquals("4242  |$a|:Teils Beil. |$9|:012834157 |$8|:--Abvz--: Mathematik alpha", line.toString());
		line = LineParser.parse("039C ƒaTeils Beil.ƒ9012834157ƒ8--Abvz--: Mathematik alpha", TAG_DB, false);
		assertEquals("4242  |$a|:Teils Beil. |$9|:012834157 |$8|:--Abvz--: Mathematik alpha", line.toString());

		line = LineParser.parse("4700 wl****Eichstätt : Lehrstuhl für Kulturgeographie, Kath. Univ. Eichstätt", TAG_DB,
				false);
		assertEquals("4700  |$a|:wl |$f|:Eichstätt : Lehrstuhl für Kulturgeographie, Kath. Univ. Eichstätt",
				line.toString());
		line = LineParser.parse("047A ƒawlƒfEichstätt : Lehrstuhl für Kulturgeographie, Kath. Univ. Eichstätt", TAG_DB,
				false);
		assertEquals("4700  |$a|:wl |$f|:Eichstätt : Lehrstuhl für Kulturgeographie, Kath. Univ. Eichstätt",
				line.toString());
		...
		line = LineParser.parse("1131 !1071861417!Konferenzschrift [Ts1]$y2010$zFallingbostel", TAG_DB, false);
		assertEquals("1131  |$9|:1071861417 |$8|:Konferenzschrift [Ts1] |$y|:2010 |$z|:Fallingbostel", line.toString());
		line = LineParser.parse("013D ƒ91071861417ƒ8Konferenzschrift [Ts1]ƒy2010ƒzFallingbostel", TAG_DB, false);
		assertEquals("1131  |$9|:1071861417 |$8|:Konferenzschrift [Ts1] |$y|:2010 |$z|:Fallingbostel", line.toString());
	...
	public final void testSE() throws IllFormattedLineException {
		...
		line = LineParser.parse("5110 !101886508X!Theon$lSmyrnaeus$aDe utilitate mathematicae", TAG_DB, false);
		assertEquals("5110  |$9|:101886508X |$8|:Theon$lSmyrnaeus$aDe utilitate mathematicae", line.toString());
		line = LineParser.parse("5111 !101886508X!Theon$lSmyrnaeus$aDe utilitate mathematicae", TAG_DB, false);
		...
		assertEquals("5560  |$b|:Produktform |$a|:Hardback |$a|:jjj", line.toString());
		assertEquals("5560 [Produktform]Hardback $ jjj", RecordUtils.toPica(line, Format.PICA3, true, '$'));

		line = LineParser.parse("5560 [lcsh]Goethe, Johann Wolfgang von, 1749-1832.--Werther.--English & German.",
				TAG_DB, false);
		assertEquals("5560  |$b|:lcsh |$a|:Goethe, Johann Wolfgang von, 1749-1832.--Werther.--English & German.",
				line.toString());

		line = LineParser.parse("5593 [Verlag]", TAG_DB, false);
		assertEquals("5593  |$b|:Verlag", line.toString());

		line = LineParser.parse("5593 !1004504950!--Tb3--Michael Gottlieb Grießbach Erben", TAG_DB, false);
		assertEquals("5593  |$9|:1004504950 |$8|:--Tb3--Michael Gottlieb Grießbach Erben", line.toString());
		...
		line = LineParser.parse("5530 #Inflation / Länder, Gebiete, Völker // Deutschland", TAG_DB, false);
		assertEquals("5530  |$g|:Inflation |$h|:Länder, Gebiete, Völker // Deutschland", line.toString());
		...
		line = LineParser.parse("5530 }Lebenserinnerungen / Frauen / Einz. Pers. → Buber-Neumann, M.", TAG_DB, false);
		assertEquals("5530  |$v|:Lebenserinnerungen / Frauen / Einz. Pers. → Buber-Neumann, M.", line.toString());
		...
		line = LineParser.parse("5560 Atlantikwall $ Norwegenbefestigung $ Dänemarkbefestigung", TAG_DB, false);
		assertEquals("5560  |$a|:Atlantikwall |$a|:Norwegenbefestigung |$a|:Dänemarkbefestigung", line.toString());

		line = LineParser.parse("5118 $123456$234516$324516$432516$534216", TAG_DB, false);
		assertEquals("5118  |$f|:123456 |$f|:234516 |$f|:324516 |$f|:432516 |$f|:534216", line.toString());
		...
		assertEquals("5530  |$a|:Jahrhundert, 18. |$f|:Allg. Geschichte |$s|:16.5 |$e|:XA-DE", line.toString());
