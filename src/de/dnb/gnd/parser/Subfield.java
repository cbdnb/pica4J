...
public class Subfield implements Serializable{
   ...
   * 						Wenn Unterfeld null ist
   * 						oder Indikator null ist.
   */
  public Subfield(final Indicator anIndicator, final String aContent)
    throws IllFormattedLineException {
    try {
      ...
      throw new IllFormattedLineException(
        "Übergebenes Unterfeld falsch: " + anIndicator + aContent);
    }
   ...
   * @throws IllFormattedLineException
   * 				Wenn substr oder Tag nicht korrekt sind.
   *
   */
