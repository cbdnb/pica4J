...
public final class SWDTagDB extends TagDB {
	...
	public static final Indicator INDICATOR_5_GKD = new Indicator("{", "}", '5',
			"GKD-Nummer (bei masch. Datenübernahme, temporäres Feld)", R, "");
	...
	public static final Indicator DOLLAR_P = new Indicator("|p|", "", 'p', "Schlagwort mit Indikator \"p\"alle (@{)", R,
			"");
	public static final Indicator DOLLAR_G = new Indicator("|g|", "", 'g', "Schlagwort mit Indikator \"g\"alle (@{)", R,
			"");
	public static final Indicator DOLLAR_S = new Indicator("|s|", "", 's', "Schlagwort mit Indikator \"s\"alle (@{)", R,
			"");
	public static final Indicator DOLLAR_C = new Indicator("|c|", "", 'c', "Schlagwort mit Indikator \"c\"alle (@{)", R,
			"");
	public static final Indicator DOLLAR_K = new Indicator("|k|", "", 'k', "Schlagwort mit Indikator \"k\"alle (@{)", R,
			"");
	public static final Indicator DOLLAR_T = new Indicator("|t|", "", 't', "Schlagwort mit Indikator \"t\"alle (@{)", R,
			"");
	public static final Indicator DOLLAR_X = new Indicator("|x|", "", 'x',
			"Schlagwort mit Indikator \"Blank\"alle (@{)", R, "");
	...
	static SWDTagDB swdTagDB;

	public static final BibliographicTag TAG_800 = new BibliographicTag("800", "041A", "Hauptschlagwort", NR, "",
			"Heading - Topical Term");
	public static final BibliographicTag TAG_801 = new BibliographicTag("801", "041B", "1. Unterschlagwort", NR, "",
			"Heading - Topical Term");
	public static final BibliographicTag TAG_802 = new BibliographicTag("802", "041K", "2. Unterschlagwort", NR, "",
			"Heading - Topical Term");
	public static final BibliographicTag TAG_803 = new BibliographicTag("803", "041L", "3. Unterschlagwort", NR, "",
			"Heading - Topical Term");
	public static final BibliographicTag TAG_804 = new BibliographicTag("804", "041M", "4. Unterschlagwort", NR, "",
			"Heading - Topical Term");
	public static final BibliographicTag TAG_805 = new BibliographicTag("805", "041N", "5. Unterschlagwort", NR, "",
			"Heading - Topical Term");
	...
	public static final BibliographicTag TAG_830 = new BibliographicTag("830", "041F", "Äquivalente Bezeichnung", R, "",
			"Heading - Topical Term");
	public static final BibliographicTag TAG_835 = new BibliographicTag("835", "041T", "Deskriptoren aus Fremdthesauri",
			R, "", "Heading - Topical Term");
	public static final BibliographicTag TAG_836 = new BibliographicTag("836", "041V", "Synonyme aus Fremdthesauri", R,
			"", "Heading - Topical Term");

	public static final BibliographicTag TAG_601 = new BibliographicTag("601", "041G", "Pauschalverweisung", NR, "",
			"");
	public static final BibliographicTag TAG_602 = new BibliographicTag("602", "041H",
			"Pauschalverweisung (Siehe-Verweisung)", NR, "", "");
	public static final BibliographicTag TAG_604 = new BibliographicTag("604", "041I",
			"Pauschalverweisung (Siehe-auch-Verweisung)", NR, "", "");
	public static final BibliographicTag TAG_606 = new BibliographicTag("606", "041O", "Zu verknüpfende Deskriptoren",
			R, "", "");
	...
	public static final BibliographicTag TAG_850 = new BibliographicTag("850", "039C", "Übergeordnetes Schlagwort", R,
			"", "Heading - Topical Term");
	public static final BibliographicTag TAG_860 = new BibliographicTag("860", "039D", "Verwandtes Schlagwort", R, "",
			"Heading - Topical Term");
	...
	private SWDTagDB() {
		...
		newTag = new DefaultGNDTag("003", "001D", "Quelle und Datum der letzten Statusvergabe", NR, "null", "", null);
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('0', " Quelle und Datum (getrennt durch \":\") ", NR, ""));

		newTag = new DefaultGNDTag("005", "002@", "Satzart", NR, "008; 079", "Fixed-Length Data Elements", null);
		addTag(newTag);
		...
		newTag = new DefaultGNDTag("007", "019@", "Ländercode", NR, "", "");
		addTag(newTag);
		newTag.add(new Indicator("/1", "", 'a', "Code nach DIN/ISO 3166", R, ""));

		newTag = new DefaultGNDTag("009", "009B", "Typ der Körperschaft / Stufe der Körperschaft", NR, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('a', "Typ", NR, ""));
		...
		newTag = new DefaultGNDTag("014", "008F", "Quelle und Datum der SWD-Ersterfassung (m)", NR, "", "", "014");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('0', "Quelle und Datum (getrennt durch \":\")", NR, ""));

		newTag = new EnumeratingTag("015", "008D", "Code \"als Zusatz zur Vorzugsbezeichnung zugelassen\" ", NR, "",
				"");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator("/", "", 'a', "B  Berufsbezeichnung als Zusatz für Personennamen", R, ""));

		newTag = new DefaultGNDTag("020", "007P", "GKD-Nummer (m)", NR, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('0', "GKD-Nummer (m)", NR, ""));

		newTag = new DefaultGNDTag("021", "007Q", "SWD-Nummer (m)", NR, "", "", "021");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('0', "SWD-Nummer (m)", NR, ""));

		newTag = new DefaultGNDTag("022", "007T", "LoC-Nummer", NR, "", "", "021");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('0', "LoC-Nummer", NR, ""));

		newTag = new DefaultGNDTag("026", "007G", "Identifikationsnummern umgelenkter Datensätze", NR, "", "", "021");
		addTag(newTag);
		...
		newBibTag = new BibliographicTag("150", "029A", "Körperschaftsname in Ansetzungsform", NR, "", "");
		addTag(newBibTag);
		newBibTag.add(new Indicator("", "", 'a', "Hauptkörperschaft (@)", NR, "", 'c'));
		newBibTag.add(new Indicator(" <", ">", 'c', "Ordnungshilfe zu Hauptkörperschaft", NR, ""));
		newBibTag.add(new Indicator(" / ", "", 'b', "Abteilung(en) ({)", R, ""));
		newBibTag.add(new Indicator(" <", ">", 'x', "Ordnungshilfe zu Abteilung(en)", R, ""));

		newTag = new DefaultGNDTag("151", "029B", "Abkürzungen der Ansetzungsform des Körperschaftsnamens", R, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('a', "Abkürzung der Ansetzungsform des Körperschaftsnamens", NR, ""));

		newBibTag = new BibliographicTag("250", "029@",
				"Körperschaftsname (Vorlage- bzw. Verweisungsform, Abkürzung zur Vorlage- bzw. Verweisungsform)", R, "",
				"");
		addTag(newBibTag);
		newBibTag.add(new Indicator("", "", 'a', "Hauptkörperschaft (@)", NR, "", 'c'));
		newBibTag.add(new Indicator(" <", ">", 'c', "Ordnungshilfe zu Hauptkörperschaft", NR, ""));
		newBibTag.add(new Indicator(" / ", "", 'b', "Abteilung(en) ({)", R, ""));
		newBibTag.add(new Indicator(" <", ">", 'x', "Ordnungshilfe zu Abteilung(en)", R, ""));
		newBibTag.add(new Indicator(" {", "}", 'd', "Abkürzung", R, ""));

		newTag = new DefaultGNDTag("255", "047C", "Zusätzliche Suchwörter", NR, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('a', "Suchwörter", NR, ""));

		newTag = new DefaultGNDTag("300", "032A", "Daten der Körperschaft", NR, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('a', "Daten", NR, ""));

		newBibTag = new BibliographicTag("321", "032H",
				"Abkürzungen für Bezeichnungen der Instrumente der E- und U- Musik (nach RAK-Musik Anlage M 4)", R, "",
				"");
		addTag(newBibTag);
		newBibTag.add(new Indicator("|", "|", 'S', "Indikator für den musikalischen Bereich", NR, "", 'c'));
		newBibTag.add(new Indicator("", "", ";", true, 'a', "Abkürzung; weitere Abk. werden mit \";\" angeschlossen ",
				R, ""));

		newBibTag = new BibliographicTag("440", "038F", "GKD-Nummer der übergeordneten Körperschaft", R, "", "");
		addTag(newBibTag);
		newBibTag.add(DOLLAR_9);
		newBibTag.add(DOLLAR_8);
		newBibTag.addAlternative(INDICATOR_5_GKD);

		newBibTag = new BibliographicTag("450", "038C", "Verknüpfung \"früherer, späterer, zeitweiser Name\"", R, "",
				"");
		addTag(newBibTag);
		newBibTag.add(new Indicator("|", "|", 'S', "MAB-Indikator", NR, "", 'c'));
		newBibTag.add(DOLLAR_9);
		newBibTag.add(DOLLAR_8);
		newBibTag.addAlternative(new Indicator("|", "|", 'S', "MAB-Indikator", NR, "", 'c'));
		newBibTag.addAlternative(INDICATOR_5_GKD);

		newBibTag = new BibliographicTag("485", "009Q", "Elektronische Adresse der Homepage einer Körperschaft", R, "",
				"");
		addTag(newBibTag);
		newBibTag.add(new Indicator("=u ", "", 'u', "URL", R, "", 'c'));
		...
		newTag = new EnumeratingTag("810", "042A", "SWD-Systematik", NR, "065", "Other Classification Number");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator(";", "", 'a', "Notation", R, ""));

		newBibTag = new BibliographicTag("811", "042B", "Ländercode nach ISO 3166", NR, "043", "Geographic area code");
		addTag(newBibTag);
		...
		newBibTag = new BibliographicTag("816", "037G", "DDC-Notation", R, "083", "Dewey Decimal Classificaton Number");
		addTag(newBibTag);
		newBibTag.add(new Indicator("", "", 'c', "DDC-Notation", NR, "", 'c'));
		newBibTag.add(new Indicator("#", "#", 'd', "Determiniertheit", NR, ""));
		newBibTag.add(new Indicator(" [", "]", 't', "\"gültig seit\" - Zeitstempel (JJJJ-MM-DD)", NR, ""));
		newBibTag.add(new Indicator(" {", "}", 'g', "Zeitstempel der letzten Überprüfung (JJJJ-MM-DD)", NR, ""));
		newBibTag.add(BEM);

		newBibTag = new BibliographicTag("818", "037I", "Veraltete Notation der Dewey-Dezimalklassifikation", R, "083",
		...
		addTag(newBibTag);
		newBibTag.add(new Indicator("|", "|", 'S', "Zeitstempel der letzten Überprüfung (JJJJ-MM-DD)", NR, ""));
		...
		newTag = new DefaultGNDTag("900", "047A", "Bemerkungen zur Ansetzungsform", NR, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('a', "Bemerkungen", NR, ""));

		newBibTag = new BibliographicTag("901", "047A/01", "Mailbox", R, "912", "");
		addTag(newBibTag);
		newBibTag.add(new Indicator("", " // ", 'z', "Datum (JJJJ-MM-TT; wird maschinell besetzt)", NR, "", 'e'));
		newBibTag.add(BEM);
		newBibTag.add(new Indicator("", "*", 'b', "Absender- / Empfänger-ISIL (a-isil e-isil)", NR, "", 'e'));
		newBibTag.add(new Indicator("", "", 'a', "Freitext", NR, "", 'e'));

		newTag = new DefaultGNDTag("902", "047A/02", "Bearbeiterzeichen", NR, "", "");
		addTag(newTag);
		newTag.addDefaultFirst(new Indicator('a', "Bearbeiterzeichen", NR, ""));
