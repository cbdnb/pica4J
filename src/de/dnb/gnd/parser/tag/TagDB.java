...
public abstract class TagDB implements Serializable {
	 ...
	 * URI, wiederholbar.
	 */
	public static final Indicator DOLLAR_U_SM_R = new Indicator("$u", "", 'u', "Uniform Resource Identifier", R, "");
	 ...
	 *
	 * @param tag Pica3- oder Pica+-Feldkennzeichnung nicht null, nicht leer. Kann
	 *            Leerzeichen vorne oder hinten enthalten.
	 ...
	 * Findet einen Tag zu einer Pica- oder Pica+ Feldkennzeichnung.
	 *
	 * @param tagStr     MARC-Feldkennzeichnung nicht null, nicht leer. Kann
	 *                   Leerzeichen vorne oder hinten enthalten.
	...
	/**
	 * Liefert die Tags, die nicht vom Benutzer an der IBW geändert werden dürfen.
	 *
	 * @return nicht null
	 */
	...
	/**
	 * Liefert zu einem GNDTag und einem Indikator das {@link Indicator}-Objekt. Es
	 * werden nicht alle Tags durchsucht.
	 *
	...
	/**
	 * Meldet den Tag bei {@link #database} (als Pica3 und Pica+), bei
	 * {@link #pica3Map}, bei {@link #picaPlusMap}und bei {@link #marcMap} mit
	 * angehängten {@link Tag#marcIndicator1} und {@link Tag#marcIndicator2} an.
	 *
	...
	/**
	 * Liefert zu einer Zeile ein Tripel aus Tag am Anfang, dem Match (getrimmt) und
	 * dem Rest. Der Rest kann mit einem Blank beginnen. Das ist gefährlich, da die
	 * WinIBW überzählige Blanks zwischen Tag und Inhalt in der Vollanzeige ("s d")
	 * verschluckt. Im Korrekturmodus sind sie dagegen wieder sichtbar.
	 *
	 *
	 * @param line != null.
