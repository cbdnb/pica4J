...
public class Indicator implements Serializable {
	...
	/**
	 * null oder von "" verschieden. Wenn das zugehörige Unterfeld wiederholt wird,
	 * so erscheint das alternative Präfix. (z.B $S in 4000: zuerst "|" später " |".
	 */
	public final String prefixAlt;

	/**
	 * Wird das zum Indikator gehörige Unterfeld mit dem alternativen Präfix
	 * angeschlossen? <br>
	 * Tritt nur bei Titeldaten auf.<br>
	 * Beispiel: <br>
	 * Feld 5450 (Notation eines Klassifikationsystems (aus Fremddaten)<br>
	 * Unterfeld $a Notation der in $b beschriebenen Klassifikation, weitere
	 * Notationen werden mit "?$?" angeschlossen.
	 *
	 */
	...
	public static final Indicator NULL_INDICATOR = new Indicator((char) 0, "Nullindikator", Repeatability.UNKNOWN,
			null);
	 ...
	 */
	public Indicator(final String prefix, final String postfix, final char indicator, final String descGerman,
			final Repeatability repeatability, final String descEnglish) {
	 ...
	 * @param descEnglish   beliebig
	 */
	public Indicator(final String prefix, final String postfix, final char indicator, final char marcIndicator,
			final String descGerman, final Repeatability repeatability, final String descEnglish) {
		RangeCheckUtils.assertReferenceParamNotNull("prefix", prefix);
		RangeCheckUtils.assertReferenceParamNotNull("postfix", postfix);
		RangeCheckUtils.assertStringParamNotNullOrWhitespace("descGerman", descGerman);
		this.prefix = prefix;
	 ...
	 */
	public Indicator(final String prefix, final String postfix, final char indicator, final String descGerman,
			final Repeatability repeatability, final String descEnglish, final char alephChar) {
		RangeCheckUtils.assertReferenceParamNotNull("prefix", prefix);
		RangeCheckUtils.assertReferenceParamNotNull("postfix", postfix);
		RangeCheckUtils.assertStringParamNotNullOrWhitespace("descGerman", descGerman);
		this.prefix = prefix;
	 ...
	 * @param descEnglish   beliebig
	 */
	public Indicator(final char indicator, final String descGerman, final Repeatability repeatability,
	 ...
	 * @param descEnglish   beliebig
	 */
	public Indicator(final char indicator, final char marcIndicator, final String descGerman,
			final Repeatability repeatability, final String descEnglish) {
		RangeCheckUtils.assertStringParamNotNullOrWhitespace("descGerman", descGerman);
		prefix = null;
		prefixAlt = null;
	 ...
	 */
	public Indicator(final char indicator, final String descGerman, final Repeatability repeatability,
			final String descEnglish, final char alephChar) {
		RangeCheckUtils.assertStringParamNotNullOrWhitespace("descGerman", descGerman);
		prefix = null;
		prefixAlt = null;
		isAttaching = false;
	 ...
	 * @param descEnglish
	 */
	public Indicator(final String prefix, final String postfix, final String prefixAlt, final boolean isAttaching,
			final char indicatorChar, final String descGerman, final Repeatability repeatability,
			final String descEnglish) {
	 ...
	 */
	public Indicator(final String prefix, final String postfix, final String prefixAlt, final boolean isAttaching,
			final char indicatorChar, final char marcIndicator, final String descGerman,
			final Repeatability repeatability, final String descEnglish) {
		RangeCheckUtils.assertStringParamNotNullOrWhitespace("prefixAlt", prefixAlt);
		this.prefix = prefix;
		this.postfix = postfix;
	...
	public static void main(final String... args) {
		final Indicator ind = new Indicator("$h", "", 'h', 'c', "Datierung", Repeatability.NON_REPEATABLE, "");
		System.out.println(ind.indicatorChar);
