...
public class RDAFormatter {
  ...
  public final String format(final Line line) throws IllFormattedLineException {
    ...
    if (tag == GNDTagDB.TAG_110 || tag == GNDTagDB.TAG_410 || tag == GNDTagDB.TAG_150
      || tag == GNDTagDB.TAG_450 || tag == GNDTagDB.TAG_153) {
  ...
  private String format111(final Line line) {
    return exceptionHandling(line, GNDTagDB.INDICATOR_111_N, GNDTagDB.INDICATOR_111_D,
      GNDTagDB.INDICATOR_111_C);
  }

  private String format100(final Line line) {
    final String p = formatSubfields(line.getSubfields());
    final Line line548 = PersonUtils.getDatlLine(actualRecord);
    String d = "";
    if (line548 != null) {
      d = ", " + format548(line548);
    }
  ...
  *
  * @param record    nicht null
  * @return          RDA-Ansetzungen der Verweisungen mit Deskriptionszeichen, ohne
  *                  $T, $U, $L, $4, $5, $v, Unicode-composed
  *
  */
