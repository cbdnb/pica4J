 ...
 * <li>{@link #urheberkennung} ???, etwa 1923 für die DNB
 * <br><br>
 * Sie kann mehrere {@link RedaktionsTyp}en bearbeiten, für jeden dieser Typen kann eine
 * andere Verbundzentrale zuständig sein.
 *
 *
 * @author baumann
 *
...
public class Library implements Comparable<Library> {
  ...
  public static void main(final String... strings) {
    System.out.println(getNullLibrary().getKurzPlusIsil());
  }
   ...
   */
  public Library(
    final String urheberkennung,
    final String nameKurz,
    final String isil,
  ...
  public String serialize() {
    String s =
      "bibliothek = new Library(\"" + urheberkennung + "\", \"" + nameKurz.replace("\"", "\\\"")
  ...
  public String toStringLang() {
    return "Library [" + "Urheberkennung=" + urheberkennung + ", " + "Name kurz=" + nameKurz + ", "
      + "Name lang=" + nameLang + ", " + "ISIL=" + isil + ", " + "Redaktionen und Verbünde="
      + redaktion2verbundISIL + "]";
  }
   ...
   *
   * @param typ auch null
   * @return    zugehörige Verbundredaktion (eventuell DEFAULT). Wenn keine vorhanden,
   *            wird angenommen, dass die Bibliothek selbst Redaktion ist.
   */
