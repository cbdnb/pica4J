...
public class MXAddress implements Comparable<MXAddress> {
	...
	/**
	 * Enum der möglichen Fälle der Adressierung in z.B. <br>
	 * <br>
	 *
	 * a-DE-188-SE e-DE-12-SE <br>
	 * <br>
	 *
	...
	/**
	 * Bildet eine Mx-Adresse wie <br>
	 * a-xDE-101-SE-F-ba <br>
	 * ab.
	 *
	 ...
	 */
	public MXAddress(final Adressierung adressierung, final boolean stumm, final Library library,
			final RedaktionsTyp redaktionsTyp, final String subadress, final String raw) {
	...
	/**
	 * In der Regel die Teilinstitution und/oder die Person (F-ba). Eventuell auch
	 * der ungeparste Teil.
	 */
	...
	/**
	 * @param setzt die Subadresse, z.B "F-ba" in "a-DE-101-SE-F-ba"; wenn null,
	 *              wird nichts gemacht.
	 */
	...
	/**
	 * Parst eine Mailbox-Adresse wie <br>
	 * <br>
	 * a-xDE-101-SE-F-ba <br>
	 * </br>
	 * und gibt ein Objekt <br>
	 * <br>
	 * (Adressierung, istStummgeschaltet, Redaktionstyp, Rest der Mx, Rohdaten) =
	 * (ABSENDER, true, DNB, SE, F-ba, a-xDE-101-SE-F-ba) <br>
	 * <br>
	 * Kann keine Bibliothek erkannt werden, wird alles in den Rest verlagert.
	 *
	 *
	 * @param mxAdStr auch null. Wenn nicht null, dann dürfen keine Leerzeichen im
	 *                Innern vorhenden sein
	...
	public boolean isSpio() {
		return getLibrary().equals(Library.SPIO);
	}

	public boolean isPseu() {
		return getLibrary().equals(Library.PSEU);
	}

	public static void main(final String... args) {

		final MXAddress mxad = parse("pseu");
		System.out.println(mxad.isPseu());
		System.out.println(mxad.isSpio());
