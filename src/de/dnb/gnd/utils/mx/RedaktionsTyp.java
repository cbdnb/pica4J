...
public enum RedaktionsTyp {
    ...
    DEFAULT(""), FE("FE"), FE_P("FE-P"), FE_K("FE-K"), FE_VD_17("FE-VD-17"), MUSIK("MUSIK"),
    SE("SE"), SE_P("SE-P"), SE_K("SE-K"), SPRACH("SPRACH"), GKD("GKD"), SWD("SWD"), DMA("DMA"),
    DEA("DEA");
  ...
  /**
   * Parst den Teil einer Mailboxadresse nach der ISIL. Der String muss
   * aus dem Redaktionstyp allein oder aus Redaktionstyp + "-" + Rest
   * bestehen. Das irrtümliche Fehlen des Rests wird akzeptiert.
   * <br>
   * Kann kein Typ erkannt werden, wird DEFAULT angenommen und alles
   * in den Rest verschoben.
   * <br>
   *
   *
   * @param s nicht null, auch Kleinbuchstaben werden akzeptiert
   ...
   */
  public static Pair<RedaktionsTyp, String> parse(final String s) {
    Objects.requireNonNull(s);
