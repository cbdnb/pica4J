...
public class Pair<A, B> implements Serializable {
	...
	/**
	 * Für häufige Fälle, Umwandlung des Entrysets einer Map in eine Liste von
	 * Paaren.
	 *
	 * @param collection nicht null.
	 * @return evenutell leer
	 */
	public static <A, B> Collection<Pair<A, B>> getPairs(final Collection<Map.Entry<A, B>> collection) {
	...
	public List<String> asList() {
		return Arrays.asList(Objects.toString(first), Objects.toString(second));
	}
