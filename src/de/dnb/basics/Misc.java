...
public class Misc {
  ...
  /**
   *  Wertet die Umleitungen (redirections) aus, um zur korrekten URL-Verbindung
   *  zu kommen.
   *
   *
   * @param url           beliebig
  ...
  public static final String getTextFromFile(final String file, final Object object) {
    ...
    final BufferedReader in =
      new BufferedReader(new InputStreamReader(object.getClass().getResourceAsStream(file)));
    ...
    try {
      ...
      JOptionPane.showMessageDialog(null, e.getMessage(), "Fehler beim Helpfile",
  ...
  public static final Date getCreationDate(final Object object) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(null, e.getMessage(), "Fehler beim Datum",
        JOptionPane.OK_CANCEL_OPTION);
    } finally {
      if (jarFile != null)
        try {
  ...
  public static void main(final String[] args) throws IOException, PrinterException {
    ...
    System.out.println(getWebsite(s));
  }

  /**
   * @param date  auch null
   * @return      Datum in der Form dd-MM-yy
   *              (12-02-15), wie in der WinIBW angezeigt
   *              oder null
   */
  ...
  /**
   * @param date  auch null
   * @return      Datum in der Form dd-MM-yy kk:mm:ss.SSS
   *              (19:33:41.000), wie in der WinIBW angezeigt
   *              oder null
   */
