...
public final class TimeUtils {
	...
	/**
	 * Datum im Format tt-mm-jj, wie es z.B. als Datum der Ersterfassung auftritt.
	 */
	public static final SimpleDateFormat PICA_DATE_FORMAT = new SimpleDateFormat("dd-MM-yy");

	/**
	 * Datum im Format jjjj-mm-tt, wie es z.B. als Datum der Mailboxen auftritt.
	 */
	...
	/**
	 * startet eine Stopuhr. Zeiten können über {@link #delta_t_millis()} oder
	...
	/**
	 * Zwischenzeit in ms. Uhr muss über {@link #startStopWatch()} gestartet worden
	 * sein.
	 *
	 * @return Zwischenzeit in ms, weitere Zwischenzeiten können genommen werden
	 */
	...
	public static boolean isGermanHoliday(final Calendar calendar) {
		...
		final GregorianCalendar rosenmontag = new GregorianCalendar(year, easterMonth, (easterDay - 48));
		final GregorianCalendar christihimmelfahrt = new GregorianCalendar(year, easterMonth, (easterDay + 39));
		final GregorianCalendar pfinstsonntag = new GregorianCalendar(year, easterMonth, (easterDay + 49));
		final GregorianCalendar pfinstmontag = new GregorianCalendar(year, easterMonth, (easterDay + 50));
		final GregorianCalendar frohnleichnahm = new GregorianCalendar(year, easterMonth, (easterDay + 60));
	 ...
	 *
	 * @param from datum 1, auch null
	 * @param to   datum 2, auch null
	 ...
	 *
	 * @param calendar1 nicht null
	 * @param calendar2 nicht null
	 * @return früheren
	 */
	...
	/**
	 *
	 * @param from nicht null
	 * @param to   nicht null
	 * @return aufsteigende Liste der Termine von from bis to (einschließlich)
	 */
	 ...
	 *         (einschließlich)
	 */
	public static List<Calendar> getWorkDaysBetween(final Calendar calendar1, final Calendar calendar2) {
	 ...
	 * @param calendar nicht null
	 *
	 * @return aufsteigende Liste der Arbeitstage einer Woche zuvor (einschließlich)
	 */
	 ...
	 * @param calendar nicht null
	 *
	 * @return aufsteigende Liste der Tage einer Woche zuvor (einschließlich)
	 */
	...
	/**
	 *
	 * @param calendar Termin nicht null
	...
	/**
	 * Macht einen neuen Termin, wobei alle Felder außer Jahr, Monat und Tag genullt
	 * werden.
	 *
	 * @param calendar nicht null
	 ...
	 * @return vierstelliges Datum in Abhängigkeit vom aktuellen Datum. Das
	 *         zurückgegebene Datum liegt immer vor dem aktuellen.
	 */
	...
	/**
	 * Wie nach Handbuch für das Feld 548 gebraucht: tt.mm.jjjj oder jjjj. Vor
	 * Christus wird vor die Jahreszahl ein 'v' eingeschoben.
	 */
	public static final DateTimeFormatter FORMATTER_548 = DateTimeFormatter.ofPattern("[d.M.][G]y");

	/**
	 * Gibt den {@link TemporalAccessor} für Formate wie 01.01.1910 oder 1910 oder
	 * 12.03.v23 . Auch Titan-Besonderheiten wie "00" oder "v00" werden erkannt. Der
	 * TA kann etwa mittels ta.get(ChronoField.YEAR) ausgelesen werden.
	 *
	 * @param s auch null
	 ...
	 */
	public static final Between<LocalDate> MAX_INTERVAL = new Between<LocalDate>(LocalDate.MIN, LocalDate.MAX);
	 ...
	 *
	 * @param s           auch null
	 * @param endOfPeriod <br>
	 *                    true: Für reine Jahreszahlen ('1234') wird der 31.12.1234
	 *                    zurückgegeben. Für 12XX wird der 31.12.1299 zurückgegeben
	 *                    <br>
	 *                    false: Der 1.1.1234, bzw der 1.1.1200
	 ...
	 */
	public static LocalDate makeLocalDate(final TemporalAccessor accessor, final boolean endOfPeriod) {
		if (accessor == null)
			return null;
	 ...
	 * eines, das aus einem Zeitpunkt besteht. Werden unbekannte Informationen durch
	 * eine 'X' ausgedrückt, so wird das zugehörige Intervall zurückgegeben: <br>
	 * 11X -> [110 .. 119] <br>
	 * v11X -> [v119 .. v110] <br>
	 * Enthält datString 'XXXX', wird das maximale Intervall zurückgegeben.
	 *
	...
	public static Between<LocalDate> get548dInterval(final String datString) {
		...
		if (!datString.contains("Jh.") && !datString.contains("Jahrhundert")) {
			...
			final Pattern jhPattern = Pattern
					.compile("(\\d+)\\." + " (Jh\\.|Jahrhundert)" + "( v\\. Chr\\.| n\\. Chr\\.)?");
	...
	/**
	 * @param source Datum im Format tt-mm-jj, wie es z.B. als Datum der
	 *               Ersterfassung auftritt
	...
	/**
	 * @param source Datum im Format jjjj-mm-tt, wie es z.B. als Datum der
	 *               Ersterfassung auftritt, auch null
	 * @return Datum oder null
	 *
	 */
